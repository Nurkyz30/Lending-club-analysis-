...
The risk model tells two stories. First, it works—default rates climb smoothly from 4.8% (low risk) to 60.5% (high risk) with no inversions. Second, the portfolio concentrates in the middle: 72% concentrated in moderate risk (scores 7-10), with largest single segment at score 8 (308K loans).
...
Composite risk score (combining grade, FICO, DTI, term) ranges from 4 to 13 with 12.5x default separation between extremes.
Portfolio concentrates in scores 7-10 (72% of volume), with largest single segment at score 8 representing 23% of entire portfolio (308K loans).
